shader_type spatial; 
render_mode unshaded, skip_vertex_transform, diffuse_lambert_wrap, specular_phong, ambient_light_disabled;
...
void fragment() {
	vec4 tex = texture(albedoTex, mix(vertex_coordinates.xy / vertex_coordinates.z, UV.xy, affine_amount));
